...
def load_img_to_numpy(image_path):
    if type(image_path) is str:
        ...
        image = image_path
    image = np.array(Image.fromarray(image).resize((TARGET_IMG_SIZE, TARGET_IMG_SIZE)))
    return image
...
def parse_args():
    ...
    parser.add_argument('--sub_exp_name', type=str, default="workdir/demo", help='sub exp name')
    parser.add_argument('--content_img_folder', type=str, default="./content_images/", help='content image paths')
    parser.add_argument('--style_img_folder', type=str, default="./style_images/", help='style image paths')
...
def main():
    ...
    for content in content_list:
        ...
        for style in style_list:
            ...
            save_image(
                image_stylized[-1:],
                os.path.join(SUB_EXP_NAME, full_image_name + "_reconstructed.png"),
            )
